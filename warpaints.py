...
for warpaint in warpaints:
    ...
    try:
        ...
        try:
            url = "http://steamcommunity.com/market/listings/440/" + warpaint.replace(" ", "%20") + "%20War%20Paint%20%28Factory%20New%29"
        ...
        with open("erros.txt", "a") as f:
            f.write("NÃO ENCONTRADO: \"" + warpaint + "\" em http://steamcommunity.com/market/listings/440/" + warpaint.replace(" ", "%20") + "%20War%20Paint%20%28Factory%20New%29\n")
